...
- Enable back `ScaledObject` resources and disable hpa for read and gateway components.
...
[Unreleased]: https://github.com/giantswarm/loki-app/compare/v0.29.1...HEAD
